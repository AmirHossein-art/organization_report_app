...
st.markdown(
    ...
    - ددلاین بر اساس تاریخ پایان دوره گزارش محاسبه می‌شود.
    - اگر گزارش بعد از ددلاین اصلی ولی قبل از پایان بافر ثبت یا ویرایش شود، تأخیری محسوب می‌شود.
    - بعد از پایان بافر، ثبت و ویرایش بسته می‌شود.
    """
)
